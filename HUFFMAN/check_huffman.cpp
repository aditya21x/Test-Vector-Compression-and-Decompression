...
int main() {
    ...
    string outputFileName = "output_huffman.txt"; // Output file for compressed data
    ...
    if (compressedSize < originalSize) {
        cout << "Compression successful. File size using huffman coding is reduced by " << (originalSize - compressedSize) << " bytes." << endl;
    ...
    cout<<"Total Efficiency using huffman coding is "<<(originalSize - compressedSize)*100/originalSize<<" %"<<endl;
    return 0;
}
